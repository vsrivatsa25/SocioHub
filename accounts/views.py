...
from main.forms import ProfilePictureForm
from main.models import ProfilePic
from .utils import (
...
class SignUpView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        if settings.ENABLE_USER_ACTIVATION:
            ...
            login(request, user)
            url = 'profilepics/default.png'
            pp = ProfilePic(user_id=request.user.id,time=datetime.datetime.now(),img=url)
            pp.save()
